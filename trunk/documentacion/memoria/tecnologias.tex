...
iBATIS asocia objetos de modelo (JavaBeans) con sentencias SQL o procedimientos almacenados mediante ficheros descriptores XML, simplificando la utilización de bases de datos. No se trata de un ORM \footnote{definir ORM!!!} puro ya que aún tenemos que escribir los SQL y el mapping se realiza a partir de los resultados del SQL.
