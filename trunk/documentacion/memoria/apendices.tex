...
<VirtualHost 127.0.0.1:80>
  DocumentRoot CARPETA_CONTENEDOR
  ServerName URL_IP
</VirtualHost> 

<Directory "CAPPETA_CONTENEDOR">
...
Tanto \textit{CARPETA\_CONTENEDOR} y \textit{URL\_IP} son variables que deberá ser configuradas por el administrador. En el caso de la versión online son \textit{C:$\backslash$elmas\_container} y \textit{www.elmas.dynalias.com} respectivamente.

\subsection{Apache Tomcat}
Se utiliza Apache Tomcat 6 como servidor web de nuestra aplicación. Se puede instalar descomprimiendo el archivo \textit{apache-tomcat-6.0.14.tar.gz}, el cual se puede obtener tanto de la carpeta \textit{INSTALACIÓN} del CD-ROM o desde \URL{http://archive.apache.org/dist/tomcat/tomcat-6/v6.0.14/bin/}. 
\\ \\
...
\end{verbatim}
	...
	\item Añadiendo el siguiente código en el tag \textit{Context} dentro del fichero \textit{conf/context.xml}:
{\tt \scriptsize
\begin{verbatim}
