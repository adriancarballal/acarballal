...
En Tapestry 5 una aplicación web se compone de páginas. El controlador de cada página está compuesto por diferentes componentes, los cuales a su vez pueden estár compuestos por otros subcomponentes (véase figura \ref{componentes}).
\begin{figure}[htp]
\centering
