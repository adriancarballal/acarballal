...
insert into usercomment values (15,2,1,"Trailers y más trailers, cambia de idea", CURRENT_TIMESTAMP);
insert into usercomment values (16,2,1,"Spider-Cerdo, Spider-Cerdo, por favor", CURRENT_TIMESTAMP);
insert into usercomment values (17,2,1,"Quiero mas videos de HOMER!!!!", CURRENT_TIMESTAMP);
insert into usercomment values (18,2,1,"De donde sacas estos videos?", CURRENT_TIMESTAMP);
insert into usercomment values (19,2,1,"Este ultimo de la tierra es genial", CURRENT_TIMESTAMP);
insert into usercomment values (20,2,1,"Tienes que subir mas videos, me encantan", CURRENT_TIMESTAMP);
